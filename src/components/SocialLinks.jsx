...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/luqman-hakim-ar-razi-9443a4282",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@luqmanarazi",
    icon: Instagram,
    url: "https://www.instagram.com/luqmanarazi?igsh=ZjBla3pocGVtbWs4&utm_source=qr",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@HakimArrazi",
    icon: Youtube,
    url: "https://www.youtube.com/@HakimArrazi",
    color: "#FF0000",
  ...
  },
  {
    ...
    url: "https://www.tiktok.com/@lhizarrd?_r=1&_t=ZS-942FuFjEr58",
    color: "black",
...
const SocialLinks = () => {
  ...
  return (
    <div className="w-full bg-surface-2 border border-line rounded-2xl p-6 py-8">
      <h3
        className="text-xl font-semibold text-fg mb-6 flex items-center gap-2"
        data-aos="fade-down"
      >
        ...
        >
          ...
          <div className="relative flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <span className="text-lg font-bold pt-[0.2rem] text-fg tracking-tight leading-none transition-colors duration-300">
          ...
          {/* External Link */}
          <ExternalLink
            className="relative w-5 h-5 text-muted group-hover:text-accent
          ...
          {[instagram, youtube].map((link, index) => (
            ...
            >
              ...
              <div className="flex flex-col min-w-0">
                <span className="text-sm font-bold text-fg transition-colors duration-300">
                  {link.displayName}
                </span>
                <span className="text-xs text-muted truncate transition-colors duration-300">
                  {link.subText}
                </span>
              </div>

              <ExternalLink
                className="w-4 h-4 text-muted group-hover:text-accent ml-auto
                                       opacity-0 group-hover:opacity-100 transition-all duration-300
