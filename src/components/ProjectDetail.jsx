...
const TechBadge = ({ tech }) => {
  ...
  return (
    <div className="group relative overflow-hidden px-3 py-2 md:px-4 md:py-2.5 bg-surface-2 rounded-xl border border-line hover:border-accent/40 transition-all duration-300 cursor-default">
      ...
      <div className="relative flex items-center gap-1.5 md:gap-2">
        ...
        <span className="text-xs md:text-sm font-medium text-fg group-hover:text-accent transition-colors">
          {tech}
        </span>
      </div>
    </div>
...
const FeatureItem = ({ feature }) => {
  return (
    <li className="group flex items-start space-x-3 p-2.5 md:p-3.5 rounded-xl hover:bg-surface-2 transition-all duration-300 border border-transparent hover:border-line">
      ...
      <span className="text-sm md:text-base text-muted group-hover:text-fg transition-colors">
        {feature}
      </span>
    </li>
  );
...
const ProjectStats = ({ project }) => {
  ...
  return (
    <div className="grid grid-cols-2 gap-3 md:gap-4 p-3 md:p-4 bg-surface-2 rounded-xl overflow-hidden relative">
      <div className="relative z-10 flex items-center space-x-2 md:space-x-3 bg-surface p-2 md:p-3 rounded-lg border border-line transition-all duration-300 hover:scale-105 hover:border-accent/50 hover:shadow-lg">
        <div className="bg-accent/15 p-1.5 md:p-2 rounded-full">
...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || 'https://github.com/Lhizaaa',
      };
  ...
  return (
    <div className="min-h-screen bg-base px-[2%] sm:px-0 relative overflow-hidden">
      {/* Background animations remain unchanged */}
      <div className="fixed inset-0 -z-10">
        <div className="absolute -inset-[10px] opacity-[0.12]">
          <div className="absolute top-0 -left-4 w-72 md:w-96 h-72 md:h-96 bg-accent rounded-full filter blur-3xl animate-blob" />
          <div className="absolute top-0 -right-4 w-72 md:w-96 h-72 md:h-96 bg-accent rounded-full filter blur-3xl animate-blob animation-delay-2000" />
          <div className="absolute -bottom-8 left-20 w-72 md:w-96 h-72 md:h-96 bg-accent rounded-full filter blur-3xl animate-blob animation-delay-4000" />
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16">
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              <div className="space-y-4 md:space-y-6">
                <h1 className="text-3xl md:text-6xl font-bold text-fg leading-tight">
                  {project.Title}
                </h1>
            ...
            <div className="space-y-6 md:space-y-10 animate-slideInRight">
              <div className="relative rounded-2xl overflow-hidden border border-line shadow-xl group">
                ...
                />
                <div className="absolute inset-0 border-2 border-transparent group-hover:border-accent/20 transition-colors duration-300 rounded-2xl" />
              </div>
