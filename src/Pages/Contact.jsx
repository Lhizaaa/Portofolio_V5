    ...
    <div className="px-[5%] sm:px-[5%] lg:px-[10%] " >
      ...
      >
        <div className="container px-[1%] grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-[45%_55%] 2xl:grid-cols-[35%_65%] gap-12" >
          <div
            className="bg-surface border border-line rounded-3xl shadow-sm p-5 py-10 sm:p-10 transform transition-all duration-500 hover:shadow-xl"
          >
            ...
            >
              ...
              >
                ...
                <input
                  ...
                  className="w-full p-4 pl-12 bg-surface-2 rounded-xl border border-line placeholder-muted text-fg focus:outline-none focus:ring-2 focus:ring-accent/30 focus:border-accent transition-all duration-300 hover:border-accent/40 disabled:opacity-50"
                  required
                />
              </div>
              <div
              ...
              >
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  disabled={isSubmitting}
                  className="w-full resize-none p-4 pl-12 bg-surface-2 rounded-xl border border-line placeholder-muted text-fg focus:outline-none focus:ring-2 focus:ring-accent/30 focus:border-accent transition-all duration-300 hover:border-accent/40 h-[9.9rem] disabled:opacity-50"
                  required
                />
              </div>
              <button
            ...
            <div className="mt-10 pt-6 border-t border-line flex justify-center space-x-6">
              <SocialLinks />
            </div>
          </div>

          <div className="bg-surface border border-line rounded-3xl p-3 py-3 md:p-10 md:py-8 shadow-sm transform transition-all duration-500 hover:shadow-xl">
            <Komentar />
          </div>
        </div>
      </div>
