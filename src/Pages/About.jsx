        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             Lulusan Teknik Jaringan Komputer dan Telekomunikasi dan Mahasiswa Informatika di Universitas Islam Indonesia yang memiliki ketertarikan besar dalam pengembangan UI/UX Design, dan Front-End. Saya berfokus pada menciptakan pengalaman digital yang menarik dan selalu berusaha memberikan solusi terbaik dalam setiap proyek yang saya kerjakan.
            </p>
