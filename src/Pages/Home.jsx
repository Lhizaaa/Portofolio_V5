...
const CTAButton = memo(({ href, text, icon: Icon }) => (
  <a href={href}>
    <button className="group relative w-[160px]">
      <div className="absolute -inset-0.5 bg-gradient-to-r from-[#2563eb] to-[#0284c7] rounded-xl opacity-50 blur-md group-hover:opacity-90 transition-all duration-700"></div>
      <div className="relative h-11 bg-[#030014] backdrop-blur-xl rounded-lg border border-white/10 leading-none overflow-hidden">
        <div className="absolute inset-0 scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-500 bg-gradient-to-r from-[#2563eb]/20 to-[#0284c7]/20"></div>
...
const SocialLink = memo(({ icon: Icon, link }) => (
  <a href={link} target="_blank" rel="noopener noreferrer">
    <button className="group relative p-3">
      <div className="absolute -inset-0.5 bg-gradient-to-r from-[#3b82f6] to-[#0ea5e9] rounded-xl blur opacity-20 group-hover:opacity-40 transition duration-300"></div>
...
const SOCIAL_LINKS = [
  ...
  { icon: Linkedin, link: "https://www.linkedin.com/in/luqman-hakim-ar-razi-9443a4282" },
  { icon: Instagram, link: "https://www.instagram.com/luqmanarazi?igsh=ZjBla3pocGVtbWs4&utm_source=qr" }
];
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden md:px-[10%] px-[5%]" id="Home">
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-4 sm:gap-8 lg:gap-12">
            {/* Left Column */}
            ...
            <div className="w-full py-0 md:py-[5%] sm:py-0 lg:w-1/2 h-[200px] sm:h-[300px] lg:h-[500px] xl:h-[600px] relative flex items-center justify-center order-2 lg:order-2 mt-4 sm:mt-0"
              ...
              <div className="relative w-full opacity-90">
                <div className={`absolute inset-0 bg-gradient-to-r from-[#3b82f6]/10 to-[#0ea5e9]/10 rounded-3xl blur-3xl transition-all duration-700 ease-in-out ${
