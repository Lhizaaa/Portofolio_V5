...
const Home = () => {
  ...
  return (
    <div className="min-h-screen overflow-hidden md:px-[10%] px-[5%]" id="Home">
            ...
            <div className="w-full lg:w-1/2 space-y-4 sm:space-y-5 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="h-8 flex items-center" data-aos="fade-up" data-aos-delay="800">
                  <span className="text-xl md:text-2xl text-fg font-light">
                    {text}
                  </span>
                  <span className="w-[3px] h-6 bg-accent ml-1 animate-blink"></span>
                </div>
